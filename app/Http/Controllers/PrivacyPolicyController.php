...
class PrivacyPolicyController extends Controller
{
    ...
    {
        $aboutSection = PrivacyPolicy::firstOrCreate(
            [],
            [
                'sub_title' => 'Privacy Policy',
                'main_title' => 'Your Privacy , Our Policy',
        ...
        return view('backend.pages.admin-privacy-policy', compact('aboutSection'));
    }

    public function update(Request $request)
    {
        $aboutSection = PrivacyPolicy::firstOrFail();
