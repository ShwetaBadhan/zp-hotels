...
use App\Models\EventAboutSection;
use Illuminate\Support\Facades\Storage;
use Illuminate\Support\Facades\Log;

class EventAboutSectionController extends Controller
{
    public function index()
    {
        $aboutSection = EventAboutSection::firstOrCreate(
            [],
            [
        ...
        return view('backend.pages.admin-event-about-section', compact('aboutSection'));
    }

    public function update(Request $request)
    {
        $aboutSection = EventAboutSection::firstOrFail();
        ...
        if ($request->hasFile('image')) {
            ...
            $imagePath = $request->file('image')->store('event-about-sections', 'public');
