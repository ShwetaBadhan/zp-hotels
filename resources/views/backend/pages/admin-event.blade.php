...
@section('content')
                ...
                <div class="col-xl-12">
                    <div class="lh-card">
                        <div class="lh-card-header">
                            <h4 class="lh-card-title">Events</h4>
                        </div>
                                    ...
                                    <tbody>
                                        @forelse ($events as $event)
                                            <tr>
                                                ...
                                                <td>{{ $event->title }}</td>
                                                <td><span
                                                        class="badge {{ $event->status === 'active' ? 'bg-success' : 'bg-secondary' }}">
            ...
            <div class="modal-content">
                <div class="modal-header border-0 pb-0">
                    <div class="form-header modal-header-title text-start mb-0">
                        <h4 class="mb-0">Add Near By event</h4>
                    </div>
    ...
    @foreach($events as $event)
        {{-- view modal --}}
        <div class="modal custom-modal fade" id="view_team{{ $event->id }}" role="dialog">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">

                    <div class="modal-header border-0 pb-0">
                        <div class="form-header modal-header-title text-start mb-0">
                            <h4 class="mb-0">View Nearby event</h4>
                        </div>
        ...
        <div class="modal custom-modal fade" id="edit_team{{ $event->id }}" role="dialog">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    @if($event->image)
                                        <img src="{{ asset('storage/' . $event->image) }}" width="80" class="mt-2">
                                    @endif
                                </div>
