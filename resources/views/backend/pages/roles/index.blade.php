                                                ...
                                                <td class="text-center" style="white-space: nowrap;">
                                                    <div class="d-flex justify-content-center align-items-center gap-1">
                                                        ...
                                                        <button type="button"
                                                            ...
                                                            title="Toggle Status">
                                                            <i
                                                                class="ri-toggle-{{ $role->status === 'active' ? 'fill' : 'line' }}"></i>
                                                        </button>
            ...
            <form action="{{ route('roles.assignPermissions') }}" method="POST">
                ...
                <div class="modal-content">
                    <div class="modal-header bg-light">
                        <h5 class="modal-title"><i class="ri-key-line me-2"></i>Assign Permissions - <span
                                id="assignRoleName"></span></h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>
                    <div class="modal-body">
                        <div class="row g-2">
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-check p-2 border rounded">
                                        ...
                                        <label class="form-check-label"
                                            for="perm_{{ $permission->id }}">{{ ucwords(str_replace('_', ' ', $permission->name)) }}</label>
                                    </div>
                                </div>
                            @endforeach
                        </div>
